...
void setup() {
  ...
  //    setChannel(uint8_t LEDAddr, bool On)  - Sets the LED at address LEDAddr (1 - 36) to value On (true/false). Values of LEDAddr at 0 or higher than 36 will be ignored and return code OUTOFRANGE (which is 0x05), will be sent back.
